<template>
  <div class="mb-4">
    ...
    <div v-if="canAccess" class="aspect-video bg-gray-100 rounded-lg flex items-center justify-center">
      <a
        :href="videoUrl"
        target="_blank"
    ...
    <div v-else class="aspect-video bg-gray-100 rounded-lg relative overflow-hidden">
      <!-- Blurred background -->
        ...
        <div class="text-center">
          ...
          <div class="mb-4">
            ...
            <p class="text-sm text-gray-600">
              Purchase to unlock this video lesson
            </p>
          </div>
