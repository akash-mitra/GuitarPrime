<template>
    <div
        :class="[
            ...
            {
                'border-gray-200 bg-gray-50': hasAccess,
                'border-gray-300 bg-gray-100 opacity-75': !hasAccess,
                'cursor-move transition-colors hover:bg-gray-100': draggable,
            },
        ]"
        :draggable="draggable"
    ...
    >
        ...
        <div class="flex items-start justify-between">
            <div class="flex-1">
                ...
                <div v-if="showReorderHandle" class="mb-2 flex items-center space-x-3">
                ...
                <h4 v-else class="font-medium" :class="hasAccess ? 'text-gray-900' : 'text-gray-600'">
                    {{ module.title }}
                </h4>
                ...
                <div class="mt-2 flex items-center space-x-2">
                    ...
                    <span v-if="!hasAccess && showAccessIndicator && !module.is_free" class="text-xs text-gray-500"> Video & downloads locked </span>
                    <!-- Free module indicator -->
                    <span v-if="module.is_free" class="text-xs text-green-600"> Free Demo </span>
                </div>
            </div>
